...
void dijkstraWithSet(int source, std::vector<std::vector<std::pair<int, int>>> &adj,
                     std::vector<int> &path, std::vector<int> &cost) {
...
void dijkstraWithPrioQueue(int source, std::vector<std::vector<std::pair<int, int>>> &adj,
                           std::vector<int> &path, std::vector<int> &cost) {
