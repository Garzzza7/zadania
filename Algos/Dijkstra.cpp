...
void dijkstra(int source, vector<vector<pair<int, int>>> &adj, vector<int> &path, vector<int> &cost)
{
    int iter = adj.size();
...
void dijkstraWithSet(int source, vector<vector<pair<int, int>>> &adj, vector<int> &path, vector<int> &cost)
{
...
void dijkstraWithPrioQueue(int source, vector<vector<pair<int, int>>> &adj, vector<int> &path, vector<int> &cost)
{
