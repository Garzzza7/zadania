...
.LFB9770:
	...
	sub	rsp, 104	#,
	.cfi_offset 3, -24
# Sieve_of_Eratosthenes.cpp:5: int main() {
	mov	rax, QWORD PTR fs:40	# tmp139, MEM[(<address-space-1> long unsigned int *)40B]
	mov	QWORD PTR -24[rbp], rax	# D.225120, tmp139
	xor	eax, eax	# tmp139
# Sieve_of_Eratosthenes.cpp:6:     ios_base::sync_with_stdio(0);
	mov	edi, 0	#,
.LEHB0:
	call	_ZNSt8ios_base15sync_with_stdioEb@PLT	#
# Sieve_of_Eratosthenes.cpp:7:     cin.tie(0);
	mov	esi, 0	#,
	lea	rax, _ZSt3cin[rip+16]	# tmp101,
	mov	rdi, rax	#, tmp101
	call	_ZNSt9basic_iosIcSt11char_traitsIcEE3tieEPSo@PLT	#
# Sieve_of_Eratosthenes.cpp:10:     cin >> n;
	lea	rax, -100[rbp]	# tmp102,
	mov	rsi, rax	#, tmp102
	lea	rax, _ZSt3cin[rip]	# tmp103,
	mov	rdi, rax	#, tmp103
	call	_ZNSirsERi@PLT	#
.LEHE0:
	lea	rax, -88[rbp]	# tmp104,
	mov	QWORD PTR -56[rbp], rax	# this, tmp104
...
# /usr/include/c++/13/bits/allocator.h:163:       allocator() _GLIBCXX_NOTHROW { }
	nop	
# Sieve_of_Eratosthenes.cpp:11:     vector<int> sieve(n + 1, 0);
	mov	DWORD PTR -80[rbp], 0	# MEM[(int *)_67],
# Sieve_of_Eratosthenes.cpp:11:     vector<int> sieve(n + 1, 0);
	mov	eax, DWORD PTR -100[rbp]	# n.0_1, n
	add	eax, 1	# _2,
# Sieve_of_Eratosthenes.cpp:11:     vector<int> sieve(n + 1, 0);
	movsx	rsi, eax	# _3, _2
	lea	rcx, -88[rbp]	# tmp105,
	lea	rdx, -80[rbp]	# tmp106,
...
# /usr/include/c++/13/bits/allocator.h:184:       ~allocator() _GLIBCXX_NOTHROW { }
	lea	rax, -88[rbp]	# tmp108,
	mov	rdi, rax	#, tmp108
	call	_ZNSt15__new_allocatorIiED2Ev	#
	nop	
# Sieve_of_Eratosthenes.cpp:12:     for (int i = 2; i <= n; i++) {
	mov	DWORD PTR -96[rbp], 2	# i,
# Sieve_of_Eratosthenes.cpp:12:     for (int i = 2; i <= n; i++) {
	jmp	.L7	#
.L12:
# Sieve_of_Eratosthenes.cpp:13: 	if (sieve[i]) {
	mov	eax, DWORD PTR -96[rbp]	# tmp109, i
	movsx	rdx, eax	# _4, tmp109
...
# Sieve_of_Eratosthenes.cpp:13: 	if (sieve[i]) {
	test	al, al	# retval.1_52
	jne	.L24	#,
# Sieve_of_Eratosthenes.cpp:16: 	for (int x = 2 * i; x <= n; x += i) {
	mov	eax, DWORD PTR -96[rbp]	# tmp114, i
	add	eax, eax	# tmp113
	mov	DWORD PTR -92[rbp], eax	# x, tmp113
# Sieve_of_Eratosthenes.cpp:16: 	for (int x = 2 * i; x <= n; x += i) {
	jmp	.L10	#
.L11:
# Sieve_of_Eratosthenes.cpp:17: 	    sieve[x] = i;
	mov	ebx, DWORD PTR -96[rbp]	# i.2_7, i
# Sieve_of_Eratosthenes.cpp:17: 	    sieve[x] = i;
	mov	eax, DWORD PTR -92[rbp]	# tmp115, x
	movsx	rdx, eax	# _8, tmp115
	lea	rax, -48[rbp]	# tmp116,
	mov	rsi, rdx	#, _8
	mov	rdi, rax	#, tmp116
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Sieve_of_Eratosthenes.cpp:17: 	    sieve[x] = i;
	mov	DWORD PTR [rax], ebx	# *_9, i.2_7
# Sieve_of_Eratosthenes.cpp:16: 	for (int x = 2 * i; x <= n; x += i) {
	mov	eax, DWORD PTR -96[rbp]	# tmp117, i
	add	DWORD PTR -92[rbp], eax	# x, tmp117
.L10:
# Sieve_of_Eratosthenes.cpp:16: 	for (int x = 2 * i; x <= n; x += i) {
	mov	eax, DWORD PTR -100[rbp]	# n.3_10, n
	cmp	DWORD PTR -92[rbp], eax	# x, n.3_10
	jle	.L11	#,
	jmp	.L9	#
.L24:
# Sieve_of_Eratosthenes.cpp:14: 	    continue;
	nop	
.L9:
# Sieve_of_Eratosthenes.cpp:12:     for (int i = 2; i <= n; i++) {
	add	DWORD PTR -96[rbp], 1	# i,
.L7:
# Sieve_of_Eratosthenes.cpp:12:     for (int i = 2; i <= n; i++) {
	mov	eax, DWORD PTR -100[rbp]	# n.4_11, n
	cmp	DWORD PTR -96[rbp], eax	# i, n.4_11
	jle	.L12	#,
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	lea	rax, -48[rbp]	# tmp118,
	mov	QWORD PTR -72[rbp], rax	# __for_range, tmp118
	mov	rax, QWORD PTR -72[rbp]	# tmp119, __for_range
	mov	rdi, rax	#, tmp119
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -88[rbp], rax	# MEM[(struct __normal_iterator *)_66], tmp121
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	mov	rax, QWORD PTR -72[rbp]	# tmp122, __for_range
	mov	rdi, rax	#, tmp122
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -80[rbp], rax	# MEM[(struct __normal_iterator *)_67], tmp124
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	jmp	.L13	#
.L14:
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	lea	rax, -88[rbp]	# tmp125,
	mov	rdi, rax	#, tmp125
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -64[rbp], rax	# a, tmp126
# Sieve_of_Eratosthenes.cpp:23: 	cout << a << " ";
	mov	rax, QWORD PTR -64[rbp]	# tmp127, a
	mov	eax, DWORD PTR [rax]	# _12, *a_43
	mov	esi, eax	#, _12
	lea	rax, _ZSt4cout[rip]	# tmp128,
	mov	rdi, rax	#, tmp128
.LEHB2:
	call	_ZNSolsEi@PLT	#
	mov	rdx, rax	# _13,
# Sieve_of_Eratosthenes.cpp:23: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp129,
	mov	rsi, rax	#, tmp129
	mov	rdi, rdx	#, _13
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
.LEHE2:
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	lea	rax, -88[rbp]	# tmp130,
	mov	rdi, rax	#, tmp130
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L13:
# Sieve_of_Eratosthenes.cpp:22:     for (auto &&a : sieve) {
	lea	rdx, -80[rbp]	# tmp131,
	lea	rax, -88[rbp]	# tmp132,
	mov	rsi, rdx	#, tmp131
	mov	rdi, rax	#, tmp132
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.5_35
	jne	.L14	#,
# Sieve_of_Eratosthenes.cpp:25:     return 0;
	mov	ebx, 0	# _38,
# Sieve_of_Eratosthenes.cpp:26: }
	lea	rax, -48[rbp]	# tmp133,
	mov	rdi, rax	#, tmp133
	call	_ZNSt6vectorIiSaIiEED1Ev	#
	mov	eax, ebx	# <retval>, _38
	mov	rdx, QWORD PTR -24[rbp]	# tmp140, D.225120
...
# /usr/include/c++/13/bits/allocator.h:184:       ~allocator() _GLIBCXX_NOTHROW { }
	mov	rbx, rax	# tmp136,
	lea	rax, -88[rbp]	# tmp135,
	mov	rdi, rax	#, tmp135
	call	_ZNSt15__new_allocatorIiED2Ev	#
	nop	
	mov	rax, rbx	# D.225117, tmp136
	mov	rdx, QWORD PTR -24[rbp]	# tmp141, D.225120
	sub	rdx, QWORD PTR fs:40	# tmp141, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L17	#,
	call	__stack_chk_fail@PLT	#
.L17:
	mov	rdi, rax	#, D.225117
.LEHB3:
...
# Sieve_of_Eratosthenes.cpp:26: }
	...
	mov	rdi, rax	#, tmp137
	call	_ZNSt6vectorIiSaIiEED1Ev	#
	mov	rax, rbx	# D.225118, tmp138
	mov	rdx, QWORD PTR -24[rbp]	# tmp142, D.225120
	sub	rdx, QWORD PTR fs:40	# tmp142, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L19	#,
	call	__stack_chk_fail@PLT	#
.L19:
	mov	rdi, rax	#, D.225118
	call	_Unwind_Resume@PLT	#
.LEHE3:
.L23:
	call	__stack_chk_fail@PLT	#
...
# /usr/include/c++/13/bits/stl_vector.h:572:       { _M_fill_initialize(__n, __value); }
	...
	mov	rax, rbx	# D.225123, tmp92
	mov	rdi, rax	#, D.225123
.LEHB6:
	call	_Unwind_Resume@PLT	#
.LEHE6:
.L28:
...
# /usr/include/c++/13/bits/stl_vector.h:735: 	std::_Destroy(this->_M_impl._M_start, this->_M_impl._M_finish,
	...
	mov	QWORD PTR -8[rbp], rax	# D.225069, _2
...
# /usr/include/c++/13/bits/stl_vector.h:873:       begin() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225124, tmp87
	xor	eax, eax	# tmp87
...
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rax, QWORD PTR -16[rbp]	# D.224993, D.214749
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp88, D.225124
...
# /usr/include/c++/13/bits/stl_vector.h:893:       end() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225125, tmp88
	xor	eax, eax	# tmp88
...
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	...
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEC1ERKS1_	#
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rax, QWORD PTR -16[rbp]	# D.224996, D.214751
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp89, D.225125
...
# /usr/include/c++/13/bits/stl_vector.h:1907:       _S_check_init_len(size_type __n, const allocator_type& __a)
	...
	mov	QWORD PTR -24[rbp], rax	# D.225126, tmp93
	xor	eax, eax	# tmp93
	...
	mov	rax, QWORD PTR -48[rbp]	# tmp88, __a
	mov	QWORD PTR -32[rbp], rax	# D.225103, tmp88
...
# /usr/include/c++/13/bits/stl_vector.h:1910: 	  __throw_length_error(
	mov	rax, QWORD PTR -24[rbp]	# tmp94, D.225126
...
# /usr/include/c++/13/bits/stl_vector.h:1913:       }
	mov	rdx, QWORD PTR -24[rbp]	# tmp95, D.225126
...
# /usr/include/c++/13/bits/stl_vector.h:335:       { _M_create_storage(__n); }
	...
	mov	rax, rbx	# D.225128, tmp88
	mov	rdi, rax	#, D.225128
.LEHB8:
	call	_Unwind_Resume@PLT	#
.LEHE8:
.L54:
...
# /usr/include/c++/13/bits/stl_vector.h:1916:       _S_max_size(const _Tp_alloc_type& __a) _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225129, tmp92
	xor	eax, eax	# tmp92
...
# /usr/include/c++/13/bits/new_allocator.h:233: 	return std::size_t(__PTRDIFF_MAX__) / sizeof(_Tp);
	movabs	rax, 2305843009213693951	# D.225093,
...
# /usr/include/c++/13/bits/stl_vector.h:1923: 	const size_t __allocmax = _Alloc_traits::max_size(__a);
	mov	QWORD PTR -40[rbp], rax	# __allocmax, D.225093
...
# /usr/include/c++/13/bits/stl_vector.h:1925:       }
	mov	rdx, QWORD PTR -8[rbp]	# tmp93, D.225129
...
.LFB11139:
	...
	mov	QWORD PTR -8[rbp], rax	# D.225062, tmp86
# /usr/include/c++/13/bits/new_allocator.h:92:       __new_allocator(const __new_allocator&) _GLIBCXX_USE_NOEXCEPT { }
	nop	
# /usr/include/c++/13/bits/allocator.h:168:       : __allocator_base<_Tp>(__a) { }
	nop	
...
.LFB11143:
	...
	mov	QWORD PTR -32[rbp], rcx	# D.220987, D.220987
...
.LFB11304:
	...
	mov	rbp, rsp	#,
	.cfi_def_cfa_register 6
	mov	QWORD PTR -8[rbp], rdi	# D.223280, D.223280
	mov	QWORD PTR -16[rbp], rsi	# D.223281, D.223281
