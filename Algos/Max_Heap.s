...
# Max_Heap.cpp:6:     int buffer = *b;
	mov	rax, QWORD PTR -32[rbp]	# tmp83, b
	mov	eax, DWORD PTR [rax]	# tmp84, *b_3(D)
	mov	DWORD PTR -4[rbp], eax	# buffer, tmp84
# Max_Heap.cpp:7:     *b = *a;
	mov	rax, QWORD PTR -24[rbp]	# tmp85, a
	mov	edx, DWORD PTR [rax]	# _1, *a_5(D)
# Max_Heap.cpp:7:     *b = *a;
	mov	rax, QWORD PTR -32[rbp]	# tmp86, b
	mov	DWORD PTR [rax], edx	# *b_3(D), _1
# Max_Heap.cpp:8:     *a = buffer;
	mov	rax, QWORD PTR -24[rbp]	# tmp87, a
	mov	edx, DWORD PTR -4[rbp]	# tmp88, buffer
	mov	DWORD PTR [rax], edx	# *a_5(D), tmp88
# Max_Heap.cpp:9: }
	nop	
	pop	rbp	#
	.cfi_def_cfa 7, 8
...
.LFE9770:
	...
	.globl	_Z7heapifyRSt6vectorIiSaIiEEi
	.type	_Z7heapifyRSt6vectorIiSaIiEEi, @function
_Z7heapifyRSt6vectorIiSaIiEEi:
.LFB9771:
	.cfi_startproc
	endbr64	
	push	rbp	#
	...
	mov	DWORD PTR -44[rbp], esi	# i, i
# Max_Heap.cpp:11:     int largest = i;
	mov	eax, DWORD PTR -44[rbp]	# tmp106, i
	mov	DWORD PTR -28[rbp], eax	# largest, tmp106
# Max_Heap.cpp:12:     int l = 2 * i + 1;
	mov	eax, DWORD PTR -44[rbp]	# tmp107, i
	add	eax, eax	# _1
# Max_Heap.cpp:12:     int l = 2 * i + 1;
	add	eax, 1	# tmp108,
	mov	DWORD PTR -24[rbp], eax	# l, tmp108
# Max_Heap.cpp:13:     int r = 2 * i + 2;
	mov	eax, DWORD PTR -44[rbp]	# tmp109, i
	add	eax, 1	# _2,
# Max_Heap.cpp:13:     int r = 2 * i + 2;
	add	eax, eax	# tmp110
	mov	DWORD PTR -20[rbp], eax	# r, tmp110
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	rax, QWORD PTR -40[rbp]	# tmp111, vec
	mov	rdi, rax	#, tmp111
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	cmp	DWORD PTR -24[rbp], eax	# l, _4
	jge	.L8	#,
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	eax, DWORD PTR -24[rbp]	# tmp112, l
	movsx	rdx, eax	# _5, tmp112
	mov	rax, QWORD PTR -40[rbp]	# tmp113, vec
	mov	rsi, rdx	#, _5
	mov	rdi, rax	#, tmp113
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	ebx, DWORD PTR [rax]	# _7, *_6
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	eax, DWORD PTR -28[rbp]	# tmp114, largest
	movsx	rdx, eax	# _8, tmp114
	mov	rax, QWORD PTR -40[rbp]	# tmp115, vec
	mov	rsi, rdx	#, _8
	mov	rdi, rax	#, tmp115
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
...
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	...
	jle	.L8	#,
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	eax, 1	# iftmp.1_25,
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	jmp	.L9	#
.L8:
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	mov	eax, 0	# iftmp.1_25,
.L9:
# Max_Heap.cpp:14:     if (l < (int) vec.size() && vec[l] > vec[largest])
	test	al, al	# iftmp.1_25
	je	.L10	#,
# Max_Heap.cpp:15: 	largest = l;
	mov	eax, DWORD PTR -24[rbp]	# tmp116, l
	mov	DWORD PTR -28[rbp], eax	# largest, tmp116
.L10:
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	rax, QWORD PTR -40[rbp]	# tmp117, vec
	mov	rdi, rax	#, tmp117
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	cmp	DWORD PTR -20[rbp], eax	# r, _12
	jge	.L11	#,
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	eax, DWORD PTR -20[rbp]	# tmp118, r
	movsx	rdx, eax	# _13, tmp118
	mov	rax, QWORD PTR -40[rbp]	# tmp119, vec
	mov	rsi, rdx	#, _13
	mov	rdi, rax	#, tmp119
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	ebx, DWORD PTR [rax]	# _15, *_14
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	eax, DWORD PTR -28[rbp]	# tmp120, largest
	movsx	rdx, eax	# _16, tmp120
	mov	rax, QWORD PTR -40[rbp]	# tmp121, vec
	mov	rsi, rdx	#, _16
	mov	rdi, rax	#, tmp121
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
...
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	...
	jle	.L11	#,
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	eax, 1	# iftmp.3_26,
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	jmp	.L12	#
.L11:
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	mov	eax, 0	# iftmp.3_26,
.L12:
# Max_Heap.cpp:16:     if (r < (int) vec.size() && vec[r] > vec[largest])
	test	al, al	# iftmp.3_26
	je	.L13	#,
# Max_Heap.cpp:17: 	largest = r;
	mov	eax, DWORD PTR -20[rbp]	# tmp122, r
	mov	DWORD PTR -28[rbp], eax	# largest, tmp122
.L13:
# Max_Heap.cpp:19:     if (largest != i) {
	mov	eax, DWORD PTR -28[rbp]	# tmp123, largest
	cmp	eax, DWORD PTR -44[rbp]	# tmp123, i
	je	.L15	#,
# Max_Heap.cpp:20: 	swap(&vec[i], &vec[largest]);
	mov	eax, DWORD PTR -28[rbp]	# tmp124, largest
	movsx	rdx, eax	# _19, tmp124
	...
	mov	rbx, rax	# _20,
# Max_Heap.cpp:20: 	swap(&vec[i], &vec[largest]);
	mov	eax, DWORD PTR -44[rbp]	# tmp126, i
	movsx	rdx, eax	# _21, tmp126
	mov	rax, QWORD PTR -40[rbp]	# tmp127, vec
	mov	rsi, rdx	#, _21
	mov	rdi, rax	#, tmp127
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:20: 	swap(&vec[i], &vec[largest]);
	...
	mov	rdi, rax	#, _22
	call	_Z4swapPiS_	#
# Max_Heap.cpp:21: 	heapify(vec, largest);
	mov	edx, DWORD PTR -28[rbp]	# tmp128, largest
	mov	rax, QWORD PTR -40[rbp]	# tmp129, vec
	mov	esi, edx	#, tmp128
	mov	rdi, rax	#, tmp129
	call	_Z7heapifyRSt6vectorIiSaIiEEi	#
.L15:
# Max_Heap.cpp:23: }
	nop	
	...
	.cfi_endproc
.LFE9771:
	.size	_Z7heapifyRSt6vectorIiSaIiEEi, .-_Z7heapifyRSt6vectorIiSaIiEEi
	.globl	_Z6insertRSt6vectorIiSaIiEEi
	.type	_Z6insertRSt6vectorIiSaIiEEi, @function
_Z6insertRSt6vectorIiSaIiEEi:
.LFB9772:
	.cfi_startproc
	endbr64	
	push	rbp	#
	...
	mov	DWORD PTR -28[rbp], esi	# newNum, newNum
# Max_Heap.cpp:25:     if ((int) vec.size() == 0) {
...
# Max_Heap.cpp:25:     if ((int) vec.size() == 0) {
	...
	sete	al	#, retval.4_12
# Max_Heap.cpp:25:     if ((int) vec.size() == 0) {
	test	al, al	# retval.4_12
	je	.L17	#,
# Max_Heap.cpp:26: 	vec.push_back(newNum);
	lea	rdx, -28[rbp]	# tmp89,
...
# Max_Heap.cpp:33: }
	jmp	.L21	#
.L17:
# Max_Heap.cpp:28: 	vec.push_back(newNum);
	lea	rdx, -28[rbp]	# tmp91,
	mov	rax, QWORD PTR -24[rbp]	# tmp92, vec
	mov	rsi, rdx	#, tmp91
	mov	rdi, rax	#, tmp92
	call	_ZNSt6vectorIiSaIiEE9push_backERKi	#
# Max_Heap.cpp:29: 	for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	mov	rax, QWORD PTR -24[rbp]	# tmp93, vec
	mov	rdi, rax	#, tmp93
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:29: 	for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	mov	edx, eax	# tmp94, _4
	shr	edx, 31	# tmp94,
	add	eax, edx	# tmp95, tmp94
	sar	eax	# tmp96
# Max_Heap.cpp:29: 	for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	sub	eax, 1	# tmp97,
	mov	DWORD PTR -4[rbp], eax	# i, tmp97
# Max_Heap.cpp:29: 	for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	jmp	.L19	#
.L20:
# Max_Heap.cpp:30: 	    heapify(vec, i);
	mov	edx, DWORD PTR -4[rbp]	# tmp98, i
...
# Max_Heap.cpp:33: }
	...
	.cfi_endproc
.LFE9772:
	.size	_Z6insertRSt6vectorIiSaIiEEi, .-_Z6insertRSt6vectorIiSaIiEEi
	.globl	_Z10deleteNodeRSt6vectorIiSaIiEEi
	.type	_Z10deleteNodeRSt6vectorIiSaIiEEi, @function
_Z10deleteNodeRSt6vectorIiSaIiEEi:
.LFB9773:
	.cfi_startproc
	endbr64	
	push	rbp	#
	...
	.cfi_offset 3, -24
	mov	QWORD PTR -40[rbp], rdi	# vec, vec
	mov	DWORD PTR -44[rbp], esi	# num, num
# Max_Heap.cpp:36:     for (i = 0; i < (int) vec.size(); i++) {
	mov	DWORD PTR -24[rbp], 0	# i,
# Max_Heap.cpp:36:     for (i = 0; i < (int) vec.size(); i++) {
	jmp	.L23	#
.L26:
# Max_Heap.cpp:37: 	if (num == vec[i])
	mov	eax, DWORD PTR -24[rbp]	# tmp99, i
	movsx	rdx, eax	# _1, tmp99
	mov	rax, QWORD PTR -40[rbp]	# tmp100, vec
	mov	rsi, rdx	#, _1
	mov	rdi, rax	#, tmp100
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:37: 	if (num == vec[i])
	mov	eax, DWORD PTR [rax]	# _3, *_2
	cmp	DWORD PTR -44[rbp], eax	# num, _3
	sete	al	#, retval.12_28
# Max_Heap.cpp:37: 	if (num == vec[i])
	test	al, al	# retval.12_28
	jne	.L29	#,
# Max_Heap.cpp:36:     for (i = 0; i < (int) vec.size(); i++) {
	add	DWORD PTR -24[rbp], 1	# i,
.L23:
# Max_Heap.cpp:36:     for (i = 0; i < (int) vec.size(); i++) {
	mov	rax, QWORD PTR -40[rbp]	# tmp101, vec
	mov	rdi, rax	#, tmp101
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:36:     for (i = 0; i < (int) vec.size(); i++) {
	cmp	DWORD PTR -24[rbp], eax	# i, _5
	setl	al	#, retval.13_25
	test	al, al	# retval.13_25
	jne	.L26	#,
	jmp	.L25	#
.L29:
# Max_Heap.cpp:38: 	    break;
	nop	
.L25:
# Max_Heap.cpp:40:     swap(&vec[i], &vec[(int) vec.size() - 1]);
	mov	rax, QWORD PTR -40[rbp]	# tmp102, vec
	mov	rdi, rax	#, tmp102
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:40:     swap(&vec[i], &vec[(int) vec.size() - 1]);
	sub	eax, 1	# _8,
# Max_Heap.cpp:40:     swap(&vec[i], &vec[(int) vec.size() - 1]);
	movsx	rdx, eax	# _9, _8
	mov	rax, QWORD PTR -40[rbp]	# tmp103, vec
	mov	rsi, rdx	#, _9
	mov	rdi, rax	#, tmp103
	call	_ZNSt6vectorIiSaIiEEixEm	#
	mov	rbx, rax	# _10,
# Max_Heap.cpp:40:     swap(&vec[i], &vec[(int) vec.size() - 1]);
	...
	movsx	rdx, eax	# _11, tmp104
	mov	rax, QWORD PTR -40[rbp]	# tmp105, vec
	mov	rsi, rdx	#, _11
	mov	rdi, rax	#, tmp105
	call	_ZNSt6vectorIiSaIiEEixEm	#
# Max_Heap.cpp:40:     swap(&vec[i], &vec[(int) vec.size() - 1]);
	...
	mov	rdi, rax	#, _12
	call	_Z4swapPiS_	#
# Max_Heap.cpp:42:     vec.pop_back();
	mov	rax, QWORD PTR -40[rbp]	# tmp106, vec
	mov	rdi, rax	#, tmp106
	call	_ZNSt6vectorIiSaIiEE8pop_backEv	#
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	mov	rax, QWORD PTR -40[rbp]	# tmp107, vec
	mov	rdi, rax	#, tmp107
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	mov	edx, eax	# tmp108, _14
	shr	edx, 31	# tmp108,
	add	eax, edx	# tmp109, tmp108
	sar	eax	# tmp110
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	sub	eax, 1	# tmp111,
	mov	DWORD PTR -20[rbp], eax	# i, tmp111
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	jmp	.L27	#
.L28:
# Max_Heap.cpp:44: 	heapify(vec, i);
	mov	edx, DWORD PTR -20[rbp]	# tmp112, i
	mov	rax, QWORD PTR -40[rbp]	# tmp113, vec
	mov	esi, edx	#, tmp112
	mov	rdi, rax	#, tmp113
	call	_Z7heapifyRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
	sub	DWORD PTR -20[rbp], 1	# i,
.L27:
# Max_Heap.cpp:43:     for (int i = (int) vec.size() / 2 - 1; i >= 0; i--) {
...
# Max_Heap.cpp:46: }
	...
	.cfi_endproc
.LFE9773:
	.size	_Z10deleteNodeRSt6vectorIiSaIiEEi, .-_Z10deleteNodeRSt6vectorIiSaIiEEi
...
.LFB9774:
	...
	sub	rsp, 168	#,
	.cfi_offset 3, -24
# Max_Heap.cpp:47: int main() {
	mov	rax, QWORD PTR fs:40	# tmp228, MEM[(<address-space-1> long unsigned int *)40B]
	mov	QWORD PTR -24[rbp], rax	# D.225488, tmp228
	xor	eax, eax	# tmp228
# Max_Heap.cpp:48:     ios::sync_with_stdio(false);
	mov	edi, 0	#,
.LEHB0:
	call	_ZNSt8ios_base15sync_with_stdioEb@PLT	#
# Max_Heap.cpp:49:     cin.tie(0);
	mov	esi, 0	#,
	lea	rax, _ZSt3cin[rip+16]	# tmp105,
	mov	rdi, rax	#, tmp105
	call	_ZNSt9basic_iosIcSt11char_traitsIcEE3tieEPSo@PLT	#
# Max_Heap.cpp:51:     cin >> n;
	lea	rax, -168[rbp]	# tmp106,
	mov	rsi, rax	#, tmp106
	lea	rax, _ZSt3cin[rip]	# tmp107,
	mov	rdi, rax	#, tmp107
	call	_ZNSirsERi@PLT	#
.LEHE0:
# Max_Heap.cpp:52:     vector<int> vec;
	lea	rax, -48[rbp]	# tmp108,
	mov	rdi, rax	#, tmp108
	call	_ZNSt6vectorIiSaIiEEC1Ev	#
# Max_Heap.cpp:53:     for (int i = 0; i < n; i++) {
	mov	DWORD PTR -164[rbp], 0	# i,
# Max_Heap.cpp:53:     for (int i = 0; i < n; i++) {
	jmp	.L34	#
.L35:
# Max_Heap.cpp:55: 	cin >> a;
...
.LEHB1:
	call	_ZNSirsERi@PLT	#
# Max_Heap.cpp:56: 	insert(vec, a);
	mov	edx, DWORD PTR -152[rbp]	# a.14_1, MEM[(int *)_27]
	lea	rax, -48[rbp]	# tmp111,
	mov	esi, edx	#, a.14_1
	mov	rdi, rax	#, tmp111
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:53:     for (int i = 0; i < n; i++) {
	add	DWORD PTR -164[rbp], 1	# i,
.L34:
# Max_Heap.cpp:53:     for (int i = 0; i < n; i++) {
	mov	eax, DWORD PTR -168[rbp]	# n.15_2, n
	cmp	DWORD PTR -164[rbp], eax	# i, n.15_2
	jl	.L35	#,
# Max_Heap.cpp:58:     insert(vec, 1);
	lea	rax, -48[rbp]	# tmp112,
	mov	esi, 1	#,
	mov	rdi, rax	#, tmp112
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:59:     insert(vec, 10);
	lea	rax, -48[rbp]	# tmp113,
	mov	esi, 10	#,
	mov	rdi, rax	#, tmp113
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:60:     insert(vec, 100);
	lea	rax, -48[rbp]	# tmp114,
	mov	esi, 100	#,
	mov	rdi, rax	#, tmp114
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:61:     insert(vec, 1000);
	lea	rax, -48[rbp]	# tmp115,
	mov	esi, 1000	#,
	mov	rdi, rax	#, tmp115
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:62:     insert(vec, 10000);
	lea	rax, -48[rbp]	# tmp116,
	mov	esi, 10000	#,
	mov	rdi, rax	#, tmp116
	call	_Z6insertRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp117,
	mov	QWORD PTR -144[rbp], rax	# __for_range, tmp117
	mov	rax, QWORD PTR -144[rbp]	# tmp118, __for_range
	mov	rdi, rax	#, tmp118
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp120
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -144[rbp]	# tmp121, __for_range
	mov	rdi, rax	#, tmp121
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp123
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	jmp	.L36	#
.L37:
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	...
	mov	QWORD PTR -56[rbp], rax	# a, tmp125
# Max_Heap.cpp:65: 	cout << a << " ";
	mov	rax, QWORD PTR -56[rbp]	# tmp126, a
	mov	eax, DWORD PTR [rax]	# _3, *a_141
	mov	esi, eax	#, _3
	...
	mov	rdx, rax	# _4,
# Max_Heap.cpp:65: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp128,
	mov	rsi, rax	#, tmp128
	mov	rdi, rdx	#, _4
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp129,
	mov	rdi, rax	#, tmp129
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L36:
# Max_Heap.cpp:64:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp130,
	lea	rax, -160[rbp]	# tmp131,
	mov	rsi, rdx	#, tmp130
	mov	rdi, rax	#, tmp131
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.16_47
	jne	.L37	#,
# Max_Heap.cpp:67:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp132,
	mov	rsi, rax	#, tmp132
	lea	rax, _ZSt4cout[rip]	# tmp133,
	mov	rdi, rax	#, tmp133
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:68:     deleteNode(vec, 10000);
	lea	rax, -48[rbp]	# tmp134,
	mov	esi, 10000	#,
	mov	rdi, rax	#, tmp134
	call	_Z10deleteNodeRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:69:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp135,
	mov	QWORD PTR -136[rbp], rax	# __for_range, tmp135
	mov	rax, QWORD PTR -136[rbp]	# tmp136, __for_range
	mov	rdi, rax	#, tmp136
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp138
# Max_Heap.cpp:69:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -136[rbp]	# tmp139, __for_range
	mov	rdi, rax	#, tmp139
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp141
# Max_Heap.cpp:69:     for (auto &&a : vec) {
	jmp	.L38	#
.L39:
# Max_Heap.cpp:69:     for (auto &&a : vec) {
	...
	mov	rdi, rax	#, tmp142
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -64[rbp], rax	# a, tmp143
# Max_Heap.cpp:70: 	cout << a << " ";
	mov	rax, QWORD PTR -64[rbp]	# tmp144, a
	mov	eax, DWORD PTR [rax]	# _5, *a_133
	mov	esi, eax	#, _5
...
.L38:
# Max_Heap.cpp:69:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp148,
	lea	rax, -160[rbp]	# tmp149,
	mov	rsi, rdx	#, tmp148
	mov	rdi, rax	#, tmp149
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.17_56
	jne	.L39	#,
# Max_Heap.cpp:72:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp150,
	mov	rsi, rax	#, tmp150
	lea	rax, _ZSt4cout[rip]	# tmp151,
	mov	rdi, rax	#, tmp151
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:73:     deleteNode(vec, 100);
	lea	rax, -48[rbp]	# tmp152,
	mov	esi, 100	#,
	mov	rdi, rax	#, tmp152
	call	_Z10deleteNodeRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp153,
	mov	QWORD PTR -128[rbp], rax	# __for_range, tmp153
	mov	rax, QWORD PTR -128[rbp]	# tmp154, __for_range
	mov	rdi, rax	#, tmp154
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp156
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -128[rbp]	# tmp157, __for_range
	mov	rdi, rax	#, tmp157
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp159
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	jmp	.L40	#
.L41:
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	...
	mov	rdi, rax	#, tmp160
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -72[rbp], rax	# a, tmp161
# Max_Heap.cpp:75: 	cout << a << " ";
	mov	rax, QWORD PTR -72[rbp]	# tmp162, a
	mov	eax, DWORD PTR [rax]	# _7, *a_125
	mov	esi, eax	#, _7
	lea	rax, _ZSt4cout[rip]	# tmp163,
	mov	rdi, rax	#, tmp163
	call	_ZNSolsEi@PLT	#
	mov	rdx, rax	# _8,
# Max_Heap.cpp:75: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp164,
	mov	rsi, rax	#, tmp164
	mov	rdi, rdx	#, _8
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp165,
	mov	rdi, rax	#, tmp165
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L40:
# Max_Heap.cpp:74:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp166,
	lea	rax, -160[rbp]	# tmp167,
	mov	rsi, rdx	#, tmp166
	mov	rdi, rax	#, tmp167
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.18_65
	jne	.L41	#,
# Max_Heap.cpp:77:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp168,
	mov	rsi, rax	#, tmp168
	lea	rax, _ZSt4cout[rip]	# tmp169,
	mov	rdi, rax	#, tmp169
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:78:     deleteNode(vec, 1000);
	lea	rax, -48[rbp]	# tmp170,
	mov	esi, 1000	#,
	mov	rdi, rax	#, tmp170
	call	_Z10deleteNodeRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp171,
	mov	QWORD PTR -120[rbp], rax	# __for_range, tmp171
	mov	rax, QWORD PTR -120[rbp]	# tmp172, __for_range
	mov	rdi, rax	#, tmp172
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp174
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -120[rbp]	# tmp175, __for_range
	mov	rdi, rax	#, tmp175
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp177
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	jmp	.L42	#
.L43:
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp178,
	mov	rdi, rax	#, tmp178
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -80[rbp], rax	# a, tmp179
# Max_Heap.cpp:80: 	cout << a << " ";
	mov	rax, QWORD PTR -80[rbp]	# tmp180, a
	mov	eax, DWORD PTR [rax]	# _9, *a_117
	mov	esi, eax	#, _9
	...
	mov	rdx, rax	# _10,
# Max_Heap.cpp:80: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp182,
	mov	rsi, rax	#, tmp182
	mov	rdi, rdx	#, _10
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp183,
	mov	rdi, rax	#, tmp183
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L42:
# Max_Heap.cpp:79:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp184,
	lea	rax, -160[rbp]	# tmp185,
	mov	rsi, rdx	#, tmp184
	mov	rdi, rax	#, tmp185
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.19_74
	jne	.L43	#,
# Max_Heap.cpp:82:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp186,
	mov	rsi, rax	#, tmp186
	lea	rax, _ZSt4cout[rip]	# tmp187,
	mov	rdi, rax	#, tmp187
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:83:     deleteNode(vec, 10);
	lea	rax, -48[rbp]	# tmp188,
	mov	esi, 10	#,
	mov	rdi, rax	#, tmp188
	call	_Z10deleteNodeRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp189,
	mov	QWORD PTR -112[rbp], rax	# __for_range, tmp189
	mov	rax, QWORD PTR -112[rbp]	# tmp190, __for_range
	mov	rdi, rax	#, tmp190
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp192
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -112[rbp]	# tmp193, __for_range
	mov	rdi, rax	#, tmp193
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp195
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	jmp	.L44	#
.L45:
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	...
	mov	rdi, rax	#, tmp196
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -88[rbp], rax	# a, tmp197
# Max_Heap.cpp:85: 	cout << a << " ";
	mov	rax, QWORD PTR -88[rbp]	# tmp198, a
	mov	eax, DWORD PTR [rax]	# _11, *a_109
	mov	esi, eax	#, _11
	...
	mov	rdx, rax	# _12,
# Max_Heap.cpp:85: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp200,
	mov	rsi, rax	#, tmp200
	mov	rdi, rdx	#, _12
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp201,
	mov	rdi, rax	#, tmp201
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L44:
# Max_Heap.cpp:84:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp202,
	lea	rax, -160[rbp]	# tmp203,
	mov	rsi, rdx	#, tmp202
	mov	rdi, rax	#, tmp203
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.20_83
	jne	.L45	#,
# Max_Heap.cpp:87:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp204,
	mov	rsi, rax	#, tmp204
	lea	rax, _ZSt4cout[rip]	# tmp205,
	mov	rdi, rax	#, tmp205
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:88:     deleteNode(vec, 9);
	lea	rax, -48[rbp]	# tmp206,
	mov	esi, 9	#,
	mov	rdi, rax	#, tmp206
	call	_Z10deleteNodeRSt6vectorIiSaIiEEi	#
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	lea	rax, -48[rbp]	# tmp207,
	mov	QWORD PTR -104[rbp], rax	# __for_range, tmp207
	mov	rax, QWORD PTR -104[rbp]	# tmp208, __for_range
	mov	rdi, rax	#, tmp208
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -160[rbp], rax	# MEM[(struct __normal_iterator *)_26], tmp210
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	mov	rax, QWORD PTR -104[rbp]	# tmp211, __for_range
	mov	rdi, rax	#, tmp211
	call	_ZNSt6vectorIiSaIiEE3endEv	#
	mov	QWORD PTR -152[rbp], rax	# MEM[(struct __normal_iterator *)_27], tmp213
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	jmp	.L46	#
.L47:
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp214,
	mov	rdi, rax	#, tmp214
	call	_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEdeEv	#
	mov	QWORD PTR -96[rbp], rax	# a, tmp215
# Max_Heap.cpp:90: 	cout << a << " ";
	mov	rax, QWORD PTR -96[rbp]	# tmp216, a
	mov	eax, DWORD PTR [rax]	# _13, *a_101
	mov	esi, eax	#, _13
	lea	rax, _ZSt4cout[rip]	# tmp217,
	mov	rdi, rax	#, tmp217
	call	_ZNSolsEi@PLT	#
	mov	rdx, rax	# _14,
# Max_Heap.cpp:90: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp218,
	mov	rsi, rax	#, tmp218
	mov	rdi, rdx	#, _14
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	lea	rax, -160[rbp]	# tmp219,
	mov	rdi, rax	#, tmp219
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEppEv	#
.L46:
# Max_Heap.cpp:89:     for (auto &&a : vec) {
	lea	rdx, -152[rbp]	# tmp220,
	lea	rax, -160[rbp]	# tmp221,
	mov	rsi, rdx	#, tmp220
	mov	rdi, rax	#, tmp221
	call	_ZN9__gnu_cxxneIPiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.21_92
	jne	.L47	#,
# Max_Heap.cpp:92:     cout << "\n";
	lea	rax, .LC1[rip]	# tmp222,
	mov	rsi, rax	#, tmp222
	lea	rax, _ZSt4cout[rip]	# tmp223,
	mov	rdi, rax	#, tmp223
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
.LEHE1:
# Max_Heap.cpp:93:     return 0;
	mov	ebx, 0	# _96,
# Max_Heap.cpp:94: }
	lea	rax, -48[rbp]	# tmp224,
	mov	rdi, rax	#, tmp224
	call	_ZNSt6vectorIiSaIiEED1Ev	#
	mov	eax, ebx	# <retval>, _96
	mov	rdx, QWORD PTR -24[rbp]	# tmp229, D.225488
...
.L52:
	endbr64	
	mov	rbx, rax	# tmp227,
	lea	rax, -48[rbp]	# tmp226,
	mov	rdi, rax	#, tmp226
	call	_ZNSt6vectorIiSaIiEED1Ev	#
	mov	rax, rbx	# D.225486, tmp227
	mov	rdx, QWORD PTR -24[rbp]	# tmp230, D.225488
	sub	rdx, QWORD PTR fs:40	# tmp230, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L50	#,
	call	__stack_chk_fail@PLT	#
.L50:
	mov	rdi, rax	#, D.225486
.LEHB2:
...
# /usr/include/c++/13/bits/stl_vector.h:1325: 	--this->_M_impl._M_finish;
	...
	mov	rax, QWORD PTR 8[rax]	# _1, this_6(D)->D.188304._M_impl.D.187644._M_finish
# /usr/include/c++/13/bits/stl_vector.h:1325: 	--this->_M_impl._M_finish;
	lea	rdx, -4[rax]	# _2,
	mov	rax, QWORD PTR -40[rbp]	# tmp87, this
	mov	QWORD PTR 8[rax], rdx	# this_6(D)->D.188304._M_impl.D.187644._M_finish, _2
# /usr/include/c++/13/bits/stl_vector.h:1326: 	_Alloc_traits::destroy(this->_M_impl, this->_M_impl._M_finish);
	...
	mov	rax, QWORD PTR 8[rax]	# _3, this_6(D)->D.188304._M_impl.D.187644._M_finish
# /usr/include/c++/13/bits/stl_vector.h:1326: 	_Alloc_traits::destroy(this->_M_impl, this->_M_impl._M_finish);
...
# /usr/include/c++/13/bits/stl_vector.h:735: 	std::_Destroy(this->_M_impl._M_start, this->_M_impl._M_finish,
	...
	mov	QWORD PTR -8[rbp], rax	# D.225433, _2
...
# /usr/include/c++/13/bits/stl_vector.h:873:       begin() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225492, tmp87
	xor	eax, eax	# tmp87
...
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rax, QWORD PTR -16[rbp]	# D.225272, D.215050
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp88, D.225492
...
# /usr/include/c++/13/bits/stl_vector.h:893:       end() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225493, tmp88
	xor	eax, eax	# tmp88
...
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	...
	call	_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEC1ERKS1_	#
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rax, QWORD PTR -16[rbp]	# D.225233, D.215052
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp89, D.225493
...
# /usr/include/c++/13/bits/vector.tcc:445:       vector<_Tp, _Alloc>::
	...
	mov	QWORD PTR -24[rbp], rax	# D.225494, tmp157
	xor	eax, eax	# tmp157
...
# /usr/include/c++/13/bits/vector.tcc:458:       const size_type __elems_before = __position - begin();
	...
	mov	rdi, rax	#, tmp125
	call	_ZNSt6vectorIiSaIiEE5beginEv	#
	mov	QWORD PTR -128[rbp], rax	# D.219737, tmp127
# /usr/include/c++/13/bits/vector.tcc:458:       const size_type __elems_before = __position - begin();
...
# /usr/include/c++/13/bits/vector.tcc:524:     }
	nop	
	mov	rax, QWORD PTR -24[rbp]	# tmp158, D.225494
...
# /usr/include/c++/13/bits/stl_vector.h:1896:       _M_check_len(size_type __n, const char* __s) const
	...
	mov	QWORD PTR -24[rbp], rax	# D.225496, tmp107
	xor	eax, eax	# tmp107
...
# /usr/include/c++/13/bits/stl_vector.h:1899: 	  __throw_length_error(__N(__s));
	mov	rax, QWORD PTR -24[rbp]	# tmp108, D.225496
...
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
	...
	call	_ZNKSt6vectorIiSaIiEE4sizeEv	#
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
	mov	QWORD PTR -40[rbp], rax	# D.221485, _6
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
...
# /usr/include/c++/13/bits/stl_vector.h:1903:       }
	mov	rdx, QWORD PTR -24[rbp]	# tmp109, D.225496
...
.LFB11313:
	...
	mov	rbp, rsp	#,
	.cfi_def_cfa_register 6
	mov	QWORD PTR -8[rbp], rdi	# D.223683, D.223683
	mov	QWORD PTR -16[rbp], rsi	# D.223684, D.223684
...
# /usr/include/c++/13/bits/stl_vector.h:1916:       _S_max_size(const _Tp_alloc_type& __a) _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.225497, tmp92
	xor	eax, eax	# tmp92
...
# /usr/include/c++/13/bits/new_allocator.h:233: 	return std::size_t(__PTRDIFF_MAX__) / sizeof(_Tp);
	movabs	rax, 2305843009213693951	# D.225461,
...
# /usr/include/c++/13/bits/stl_vector.h:1923: 	const size_t __allocmax = _Alloc_traits::max_size(__a);
	mov	QWORD PTR -40[rbp], rax	# __allocmax, D.225461
...
# /usr/include/c++/13/bits/stl_vector.h:1925:       }
	mov	rdx, QWORD PTR -8[rbp]	# tmp93, D.225497
