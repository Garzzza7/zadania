	.file	"Segment_Tree_Range_Sum.cpp"
...
# Segment_Tree_Range_Sum.cpp:10:     if (node_left >= query_left && node_right <= query_right) {
...
# Segment_Tree_Range_Sum.cpp:10:     if (node_left >= query_left && node_right <= query_right) {
	...
	jg	.L12	#,
# Segment_Tree_Range_Sum.cpp:11: 	return tree[start_node];
...
# Segment_Tree_Range_Sum.cpp:11: 	return tree[start_node];
	jmp	.L13	#
.L12:
# Segment_Tree_Range_Sum.cpp:13:     if (node_right < query_left || node_left > query_right) {
...
# Segment_Tree_Range_Sum.cpp:13:     if (node_right < query_left || node_left > query_right) {
	...
	jle	.L15	#,
.L14:
# Segment_Tree_Range_Sum.cpp:14: 	return 0;
	mov	eax, 0	# _10,
	jmp	.L13	#
.L15:
# Segment_Tree_Range_Sum.cpp:16:     long long mid = (node_left + node_right) / 2;
...
# Segment_Tree_Range_Sum.cpp:18: 	sum_query(2 * start_node, node_left, mid, query_left, query_right) +
	...
	mov	rbx, rax	# _5,
# Segment_Tree_Range_Sum.cpp:19: 	sum_query(2 * start_node + 1, mid + 1, node_right, query_left,
...
# Segment_Tree_Range_Sum.cpp:19: 	sum_query(2 * start_node + 1, mid + 1, node_right, query_left,
	...
	mov	rdx, rax	#, tmp112
	call	_Z9sum_queryxxxxx	#
# Segment_Tree_Range_Sum.cpp:20: 		  query_right);
	add	rax, rbx	# tmp113, _5
	mov	QWORD PTR -24[rbp], rax	# sum, tmp113
# Segment_Tree_Range_Sum.cpp:21:     return sum;
	mov	rax, QWORD PTR -24[rbp]	# _10, sum
.L13:
# Segment_Tree_Range_Sum.cpp:22: }
...
# Segment_Tree_Range_Sum.cpp:26:     if (node_left >= query_left && node_right <= query_right) {
...
# Segment_Tree_Range_Sum.cpp:26:     if (node_left >= query_left && node_right <= query_right) {
	...
	jg	.L17	#,
# Segment_Tree_Range_Sum.cpp:27: 	tree[start_node] = value;
...
# Segment_Tree_Range_Sum.cpp:28: 	return;
	jmp	.L16	#
.L17:
# Segment_Tree_Range_Sum.cpp:30:     if (node_right < query_left || node_left > query_right) {
...
# Segment_Tree_Range_Sum.cpp:30:     if (node_right < query_left || node_left > query_right) {
	...
	jg	.L21	#,
# Segment_Tree_Range_Sum.cpp:33:     long long mid = (node_left + node_right) / 2;
...
# Segment_Tree_Range_Sum.cpp:34:     recursive_update(2 * start_node, node_left, mid, query_left, query_right,
...
# Segment_Tree_Range_Sum.cpp:36:     recursive_update(2 * start_node + 1, mid + 1, node_right, query_left,
...
# Segment_Tree_Range_Sum.cpp:36:     recursive_update(2 * start_node + 1, mid + 1, node_right, query_left,
	...
	mov	rdx, rax	#, tmp123
	call	_Z16recursive_updatexxxxxx	#
# Segment_Tree_Range_Sum.cpp:38:     tree[start_node] = tree[start_node * 2] + tree[start_node * 2 + 1];
...
# Segment_Tree_Range_Sum.cpp:38:     tree[start_node] = tree[start_node * 2] + tree[start_node * 2 + 1];
	...
	jmp	.L16	#
.L21:
# Segment_Tree_Range_Sum.cpp:31: 	return;
	nop	
.L16:
# Segment_Tree_Range_Sum.cpp:39: }
	mov	rbx, QWORD PTR -8[rbp]	#,
	leave	
	.cfi_def_cfa 7, 8
	ret	
...
# Segment_Tree_Range_Sum.cpp:41:     tree[tree_size + index] = value;
...
# Segment_Tree_Range_Sum.cpp:42:     for (int i = (tree_size + index) / 2; i >= 1; i /= 2) {
...
# Segment_Tree_Range_Sum.cpp:42:     for (int i = (tree_size + index) / 2; i >= 1; i /= 2) {
	jmp	.L23	#
.L24:
# Segment_Tree_Range_Sum.cpp:43: 	tree[i] = tree[i * 2] + tree[i * 2 + 1];
...
.LFB9783:
	...
	sub	rsp, 88	#,
	.cfi_offset 3, -24
# Segment_Tree_Range_Sum.cpp:46: int main() {
	mov	rax, QWORD PTR fs:40	# tmp163, MEM[(<address-space-1> long unsigned int *)40B]
	mov	QWORD PTR -24[rbp], rax	# D.226846, tmp163
	xor	eax, eax	# tmp163
# Segment_Tree_Range_Sum.cpp:47:     ios::sync_with_stdio(false);
	mov	edi, 0	#,
.LEHB0:
	call	_ZNSt8ios_base15sync_with_stdioEb@PLT	#
# Segment_Tree_Range_Sum.cpp:48:     cin.tie(0);
	mov	esi, 0	#,
	lea	rax, _ZSt3cin[rip+16]	# tmp120,
	mov	rdi, rax	#, tmp120
	call	_ZNSt9basic_iosIcSt11char_traitsIcEE3tieEPSo@PLT	#
# Segment_Tree_Range_Sum.cpp:50:     cin >> tree_size;
	lea	rax, tree_size[rip]	# tmp121,
	mov	rsi, rax	#, tmp121
	lea	rax, _ZSt3cin[rip]	# tmp122,
	mov	rdi, rax	#, tmp122
	call	_ZNSirsERi@PLT	#
.LEHE0:
# Segment_Tree_Range_Sum.cpp:51:     vector<long long> initial_array;
	lea	rax, -48[rbp]	# tmp123,
	mov	rdi, rax	#, tmp123
	call	_ZNSt6vectorIxSaIxEEC1Ev	#
# Segment_Tree_Range_Sum.cpp:52:     for (int i = 0; i < tree_size; i++) {
	mov	DWORD PTR -92[rbp], 0	# i,
# Segment_Tree_Range_Sum.cpp:52:     for (int i = 0; i < tree_size; i++) {
	jmp	.L26	#
.L27:
# Segment_Tree_Range_Sum.cpp:54: 	cin >> a;
...
.LEHB1:
	call	_ZNSirsERi@PLT	#
# Segment_Tree_Range_Sum.cpp:55: 	initial_array.push_back(a);
	mov	eax, DWORD PTR -80[rbp]	# a.7_1, MEM[(int *)_97]
	cdqe
	mov	QWORD PTR -72[rbp], rax	# MEM[(long long int *)_98], _2
# Segment_Tree_Range_Sum.cpp:55: 	initial_array.push_back(a);
	lea	rdx, -72[rbp]	# tmp126,
...
# Segment_Tree_Range_Sum.cpp:52:     for (int i = 0; i < tree_size; i++) {
	...
	jl	.L27	#,
# Segment_Tree_Range_Sum.cpp:57:     while (__builtin_popcount(tree_size) != 1) {
	jmp	.L28	#
.L29:
# Segment_Tree_Range_Sum.cpp:58: 	initial_array.push_back(0);
	mov	QWORD PTR -72[rbp], 0	# MEM[(long long int *)_98],
# Segment_Tree_Range_Sum.cpp:58: 	initial_array.push_back(0);
	lea	rdx, -72[rbp]	# tmp128,
	lea	rax, -48[rbp]	# tmp129,
	mov	rsi, rdx	#, tmp128
	mov	rdi, rax	#, tmp129
	call	_ZNSt6vectorIxSaIxEE9push_backEOx	#
# Segment_Tree_Range_Sum.cpp:59: 	tree_size++;
...
# Segment_Tree_Range_Sum.cpp:57:     while (__builtin_popcount(tree_size) != 1) {
	...
	mov	eax, eax	# tmp130, tree_size.11_7
	mov	rdi, rax	#, tmp130
	call	__popcountdi2@PLT	#
# Segment_Tree_Range_Sum.cpp:57:     while (__builtin_popcount(tree_size) != 1) {
	cmp	eax, 1	# _8,
	jne	.L29	#,
# Segment_Tree_Range_Sum.cpp:61:     tree.resize(2 * tree_size);
	mov	eax, DWORD PTR tree_size[rip]	# tree_size.12_9, tree_size
	add	eax, eax	# _10
# Segment_Tree_Range_Sum.cpp:61:     tree.resize(2 * tree_size);
	cdqe
	mov	rsi, rax	#, _11
	lea	rax, tree[rip]	# tmp132,
	mov	rdi, rax	#, tmp132
	call	_ZNSt6vectorIxSaIxEE6resizeEm	#
# Segment_Tree_Range_Sum.cpp:62:     for (int i = 0; i < tree_size; i++) {
	mov	DWORD PTR -88[rbp], 0	# i,
# Segment_Tree_Range_Sum.cpp:62:     for (int i = 0; i < tree_size; i++) {
	jmp	.L30	#
.L31:
# Segment_Tree_Range_Sum.cpp:63: 	tree[tree_size + i] = initial_array[i];
	mov	eax, DWORD PTR -88[rbp]	# tmp133, i
	movsx	rdx, eax	# _12, tmp133
...
# Segment_Tree_Range_Sum.cpp:63: 	tree[tree_size + i] = initial_array[i];
	...
	mov	eax, DWORD PTR -88[rbp]	# tmp135, i
...
# Segment_Tree_Range_Sum.cpp:62:     for (int i = 0; i < tree_size; i++) {
	...
	jl	.L31	#,
# Segment_Tree_Range_Sum.cpp:65:     for (int i = tree_size - 1; i >= 1; i--) {
	mov	eax, DWORD PTR tree_size[rip]	# tree_size.15_20, tree_size
# Segment_Tree_Range_Sum.cpp:65:     for (int i = tree_size - 1; i >= 1; i--) {
	sub	eax, 1	# tmp137,
	mov	DWORD PTR -84[rbp], eax	# i, tmp137
# Segment_Tree_Range_Sum.cpp:65:     for (int i = tree_size - 1; i >= 1; i--) {
	jmp	.L32	#
.L33:
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
	mov	eax, DWORD PTR -84[rbp]	# tmp138, i
	add	eax, eax	# _21
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
	cdqe
	mov	rsi, rax	#, _22
	lea	rax, tree[rip]	# tmp139,
	mov	rdi, rax	#, tmp139
	call	_ZNSt6vectorIxSaIxEEixEm	#
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
	mov	rbx, QWORD PTR [rax]	# _24, *_23
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
	mov	eax, DWORD PTR -84[rbp]	# tmp140, i
	add	eax, eax	# _25
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
	add	eax, 1	# _26,
# Segment_Tree_Range_Sum.cpp:66: 	tree[i] = tree[2 * i] + tree[2 * i + 1];
...
# Segment_Tree_Range_Sum.cpp:65:     for (int i = tree_size - 1; i >= 1; i--) {
	...
	jg	.L33	#,
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	lea	rax, tree[rip]	# tmp144,
	mov	QWORD PTR -64[rbp], rax	# __for_range, tmp144
	mov	rax, QWORD PTR -64[rbp]	# tmp145, __for_range
	mov	rdi, rax	#, tmp145
	call	_ZNSt6vectorIxSaIxEE5beginEv	#
	mov	QWORD PTR -80[rbp], rax	# MEM[(struct __normal_iterator *)_97], tmp147
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	mov	rax, QWORD PTR -64[rbp]	# tmp148, __for_range
	mov	rdi, rax	#, tmp148
	call	_ZNSt6vectorIxSaIxEE3endEv	#
	mov	QWORD PTR -72[rbp], rax	# MEM[(struct __normal_iterator *)_98], tmp150
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	jmp	.L34	#
.L35:
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	...
	mov	QWORD PTR -56[rbp], rax	# a, tmp152
# Segment_Tree_Range_Sum.cpp:70: 	cout << a << " ";
	mov	rax, QWORD PTR -56[rbp]	# tmp153, a
	mov	rax, QWORD PTR [rax]	# _33, *a_67
	mov	rsi, rax	#, _33
	...
	mov	rdx, rax	# _34,
# Segment_Tree_Range_Sum.cpp:70: 	cout << a << " ";
	lea	rax, .LC0[rip]	# tmp155,
	mov	rsi, rax	#, tmp155
	mov	rdi, rdx	#, _34
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT	#
.LEHE1:
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	lea	rax, -80[rbp]	# tmp156,
	mov	rdi, rax	#, tmp156
	call	_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEppEv	#
.L34:
# Segment_Tree_Range_Sum.cpp:69:     for (auto &&a : tree) {
	lea	rdx, -72[rbp]	# tmp157,
	lea	rax, -80[rbp]	# tmp158,
	mov	rsi, rdx	#, tmp157
	mov	rdi, rax	#, tmp158
	call	_ZN9__gnu_cxxneIPxSt6vectorIxSaIxEEEEbRKNS_17__normal_iteratorIT_T0_EESA_	#
	test	al, al	# retval.16_60
	jne	.L35	#,
# Segment_Tree_Range_Sum.cpp:80:     return 0;
	mov	ebx, 0	# _63,
# Segment_Tree_Range_Sum.cpp:81: }
	lea	rax, -48[rbp]	# tmp159,
	mov	rdi, rax	#, tmp159
	call	_ZNSt6vectorIxSaIxEED1Ev	#
	mov	eax, ebx	# <retval>, _63
	mov	rdx, QWORD PTR -24[rbp]	# tmp164, D.226846
	sub	rdx, QWORD PTR fs:40	# tmp164, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L39	#,
	jmp	.L41	#
.L40:
	endbr64	
	...
	mov	rdi, rax	#, tmp161
	call	_ZNSt6vectorIxSaIxEED1Ev	#
	mov	rax, rbx	# D.226844, tmp162
	mov	rdx, QWORD PTR -24[rbp]	# tmp165, D.226846
	sub	rdx, QWORD PTR fs:40	# tmp165, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L38	#,
	call	__stack_chk_fail@PLT	#
.L38:
	mov	rdi, rax	#, D.226844
.LEHB2:
...
.LLSDACSB9783:
	.uleb128 .LEHB0-.LFB9783
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB9783
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L40-.LFB9783
	.uleb128 0
	.uleb128 .LEHB2-.LFB9783
	.uleb128 .LEHE2-.LEHB2
	.uleb128 0
	.uleb128 0
.LLSDACSE9783:
...
# /usr/include/c++/13/bits/stl_vector.h:735: 	std::_Destroy(this->_M_impl._M_start, this->_M_impl._M_finish,
	...
	mov	QWORD PTR -8[rbp], rax	# D.226781, _2
...
# /usr/include/c++/13/bits/stl_vector.h:1017: 	else if (__new_size < size())
	...
	setb	al	#, retval.26_15
# /usr/include/c++/13/bits/stl_vector.h:1017: 	else if (__new_size < size())
	test	al, al	# retval.26_15
	je	.L54	#,
...
# /usr/include/c++/13/bits/stl_vector.h:873:       begin() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.226850, tmp87
	xor	eax, eax	# tmp87
...
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rax, QWORD PTR -16[rbp]	# D.226683, D.215972
# /usr/include/c++/13/bits/stl_vector.h:874:       { return iterator(this->_M_impl._M_start); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp88, D.226850
...
# /usr/include/c++/13/bits/stl_vector.h:893:       end() _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.226851, tmp88
	xor	eax, eax	# tmp88
...
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	...
	call	_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEC1ERKS1_	#
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rax, QWORD PTR -16[rbp]	# D.226686, D.215974
# /usr/include/c++/13/bits/stl_vector.h:894:       { return iterator(this->_M_impl._M_finish); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp89, D.226851
...
# /usr/include/c++/13/bits/vector.tcc:123: 	  _M_realloc_insert(end(), std::forward<_Args>(__args)...);
	...
	mov	rdi, rax	#, tmp111
	call	_ZNSt6vectorIxSaIxEE3endEv	#
	mov	rcx, rax	# D.226523,
# /usr/include/c++/13/bits/vector.tcc:123: 	  _M_realloc_insert(end(), std::forward<_Args>(__args)...);
	mov	rax, QWORD PTR -72[rbp]	# tmp112, this
	mov	rdx, rbx	#, _8
	mov	rsi, rcx	#, D.226523
	mov	rdi, rax	#, tmp112
...
.L84:
# /usr/include/c++/13/bits/vector.tcc:643: 	  if (__size > max_size() || __navail > max_size() - __size)
	mov	eax, 1	# iftmp.28_31,
# /usr/include/c++/13/bits/vector.tcc:643: 	  if (__size > max_size() || __navail > max_size() - __size)
	jmp	.L86	#
.L85:
# /usr/include/c++/13/bits/vector.tcc:643: 	  if (__size > max_size() || __navail > max_size() - __size)
	mov	eax, 0	# iftmp.28_31,
.L86:
# /usr/include/c++/13/bits/vector.tcc:643: 	  if (__size > max_size() || __navail > max_size() - __size)
	test	al, al	# iftmp.28_31
...
# /usr/include/c++/13/bits/vector.tcc:671: 		  __catch(...)
	...
	mov	rax, rbx	# D.226852, tmp156
	mov	rdi, rax	#, D.226852
.LEHB6:
	call	_Unwind_Resume@PLT	#
.LEHE6:
.L93:
...
.LLSDA10931:
	.byte	0xff
	.byte	0x9b
	.uleb128 .LLSDATT10931-.LLSDATTD10931
.LLSDATTD10931:
	.byte	0x1
	.uleb128 .LLSDACSE10931-.LLSDACSB10931
.LLSDACSB10931:
	.uleb128 .LEHB3-.LFB10931
	.uleb128 .LEHE3-.LEHB3
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB4-.LFB10931
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L91-.LFB10931
	.uleb128 0x1
	.uleb128 .LEHB5-.LFB10931
	.uleb128 .LEHE5-.LEHB5
	.uleb128 .L92-.LFB10931
	.uleb128 0
	.uleb128 .LEHB6-.LFB10931
	.uleb128 .LEHE6-.LEHB6
	.uleb128 0
	.uleb128 0
.LLSDACSE10931:
...
# /usr/include/c++/13/bits/stl_vector.h:1937: 	    std::_Destroy(__pos, this->_M_impl._M_finish,
	...
	mov	QWORD PTR -8[rbp], rax	# D.226772, _5
# /usr/include/c++/13/bits/alloc_traits.h:948:       std::_Destroy(__first, __last);
...
# /usr/include/c++/13/bits/vector.tcc:445:       vector<_Tp, _Alloc>::
	...
	mov	QWORD PTR -24[rbp], rax	# D.226854, tmp157
	xor	eax, eax	# tmp157
...
# /usr/include/c++/13/bits/vector.tcc:458:       const size_type __elems_before = __position - begin();
	...
	mov	rdi, rax	#, tmp125
	call	_ZNSt6vectorIxSaIxEE5beginEv	#
	mov	QWORD PTR -128[rbp], rax	# D.222568, tmp127
# /usr/include/c++/13/bits/vector.tcc:458:       const size_type __elems_before = __position - begin();
...
# /usr/include/c++/13/bits/vector.tcc:524:     }
	nop	
	mov	rax, QWORD PTR -24[rbp]	# tmp158, D.226854
...
.LFB11162:
	...
	mov	QWORD PTR -8[rbp], rdi	# __first, __first
	mov	QWORD PTR -16[rbp], rsi	# __n, __n
	mov	QWORD PTR -24[rbp], rdx	# D.222602, D.222602
...
# /usr/include/c++/13/bits/stl_vector.h:1896:       _M_check_len(size_type __n, const char* __s) const
	...
	mov	QWORD PTR -24[rbp], rax	# D.226857, tmp107
	xor	eax, eax	# tmp107
...
# /usr/include/c++/13/bits/stl_vector.h:1898: 	if (max_size() - size() < __n)
	...
	mov	rdx, rbx	# _3, _1
# /usr/include/c++/13/bits/stl_vector.h:1898: 	if (max_size() - size() < __n)
	mov	rax, QWORD PTR -64[rbp]	# __n.18_4, __n
	cmp	rdx, rax	# _3, __n.18_4
	setb	al	#, retval.17_18
# /usr/include/c++/13/bits/stl_vector.h:1898: 	if (max_size() - size() < __n)
	test	al, al	# retval.17_18
	je	.L113	#,
# /usr/include/c++/13/bits/stl_vector.h:1899: 	  __throw_length_error(__N(__s));
	mov	rax, QWORD PTR -24[rbp]	# tmp108, D.226857
...
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
	...
	call	_ZNKSt6vectorIxSaIxEE4sizeEv	#
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
	mov	QWORD PTR -40[rbp], rax	# D.222611, _6
# /usr/include/c++/13/bits/stl_vector.h:1901: 	const size_type __len = size() + (std::max)(size(), __n);
...
.L116:
# /usr/include/c++/13/bits/stl_vector.h:1902: 	return (__len < size() || __len > max_size()) ? max_size() : __len;
	mov	rax, QWORD PTR -32[rbp]	# iftmp.19_11, __len
.L117:
# /usr/include/c++/13/bits/stl_vector.h:1903:       }
	mov	rdx, QWORD PTR -24[rbp]	# tmp109, D.226857
...
.LFB11314:
	...
	mov	rbp, rsp	#,
	.cfi_def_cfa_register 6
	mov	QWORD PTR -8[rbp], rdi	# D.224769, D.224769
	mov	QWORD PTR -16[rbp], rsi	# D.224770, D.224770
...
# /usr/include/c++/13/bits/stl_iterator.h:1157:       operator-(difference_type __n) const _GLIBCXX_NOEXCEPT
	...
	mov	QWORD PTR -8[rbp], rax	# D.226858, tmp93
	xor	eax, eax	# tmp93
...
# /usr/include/c++/13/bits/stl_iterator.h:1158:       { return __normal_iterator(_M_current - __n); }
	mov	rdx, QWORD PTR -48[rbp]	# __n.24_2, __n
# /usr/include/c++/13/bits/stl_iterator.h:1158:       { return __normal_iterator(_M_current - __n); }
	sal	rdx, 3	# _3,
	neg	rdx	# _4
	add	rax, rdx	# _5, _4
	mov	QWORD PTR -24[rbp], rax	# D.224789, _5
# /usr/include/c++/13/bits/stl_iterator.h:1158:       { return __normal_iterator(_M_current - __n); }
	...
	call	_ZN9__gnu_cxx17__normal_iteratorIPxSt6vectorIxSaIxEEEC1ERKS1_	#
# /usr/include/c++/13/bits/stl_iterator.h:1158:       { return __normal_iterator(_M_current - __n); }
	mov	rax, QWORD PTR -16[rbp]	# D.226619, D.224790
# /usr/include/c++/13/bits/stl_iterator.h:1158:       { return __normal_iterator(_M_current - __n); }
	mov	rdx, QWORD PTR -8[rbp]	# tmp94, D.226858
...
# /usr/include/c++/13/bits/stl_vector.h:1916:       _S_max_size(const _Tp_alloc_type& __a) _GLIBCXX_NOEXCEPT
	mov	rax, QWORD PTR fs:40	# tmp92, MEM[(<address-space-1> long unsigned int *)40B]
	mov	QWORD PTR -8[rbp], rax	# D.226859, tmp92
	xor	eax, eax	# tmp92
...
# /usr/include/c++/13/bits/new_allocator.h:233: 	return std::size_t(__PTRDIFF_MAX__) / sizeof(_Tp);
	movabs	rax, 1152921504606846975	# D.226811,
...
# /usr/include/c++/13/bits/stl_vector.h:1923: 	const size_t __allocmax = _Alloc_traits::max_size(__a);
	mov	QWORD PTR -40[rbp], rax	# __allocmax, D.226811
...
# /usr/include/c++/13/bits/stl_vector.h:1925:       }
	mov	rdx, QWORD PTR -8[rbp]	# tmp93, D.226859
	sub	rdx, QWORD PTR fs:40	# tmp93, MEM[(<address-space-1> long unsigned int *)40B]
	je	.L140	#,
	call	__stack_chk_fail@PLT	#
.L140:
...
.LFB11428:
	...
	mov	QWORD PTR -24[rbp], rdi	# this, this
	mov	QWORD PTR -32[rbp], rsi	# __n, __n
	mov	QWORD PTR -40[rbp], rdx	# D.225522, D.225522
	mov	rax, QWORD PTR -24[rbp]	# tmp90, this
	mov	QWORD PTR -8[rbp], rax	# this, tmp90
# /usr/include/c++/13/bits/new_allocator.h:233: 	return std::size_t(__PTRDIFF_MAX__) / sizeof(_Tp);
	movabs	rax, 1152921504606846975	# D.226837,
# /usr/include/c++/13/bits/new_allocator.h:134: 	if (__builtin_expect(__n > this->_M_max_size(), false))
	cmp	rax, QWORD PTR -32[rbp]	# D.226837, __n
	setb	al	#, _2
# /usr/include/c++/13/bits/new_allocator.h:134: 	if (__builtin_expect(__n > this->_M_max_size(), false))
	movzx	eax, al	# _3, _2
# /usr/include/c++/13/bits/new_allocator.h:134: 	if (__builtin_expect(__n > this->_M_max_size(), false))
	test	rax, rax	# _4
	setne	al	#, retval.21_9
# /usr/include/c++/13/bits/new_allocator.h:134: 	if (__builtin_expect(__n > this->_M_max_size(), false))
	test	al, al	# retval.21_9
	je	.L152	#,
...
# /usr/include/c++/13/bits/stl_uninitialized.h:1131: 	  __builtin_memmove(__result, __first, __count * sizeof(_Tp));
	mov	rax, QWORD PTR -8[rbp]	# __count.22_2, __count
# /usr/include/c++/13/bits/stl_uninitialized.h:1131: 	  __builtin_memmove(__result, __first, __count * sizeof(_Tp));
...
# /usr/include/c++/13/bits/stl_uninitialized.h:1133:       return __result + __count;
	mov	rax, QWORD PTR -8[rbp]	# __count.23_4, __count
# /usr/include/c++/13/bits/stl_uninitialized.h:1133:       return __result + __count;
...
# /usr/include/c++/13/bits/stl_algobase.h:1157:       return std::__fill_n_a(__first, std::__size_to_integer(__n), __value,
	...
	mov	rcx, rax	# _1,
# /usr/include/c++/13/bits/stl_algobase.h:1157:       return std::__fill_n_a(__first, std::__size_to_integer(__n), __value,
	mov	rax, QWORD PTR -8[rbp]	# __first.29_2, __first
	mov	rdx, QWORD PTR -24[rbp]	# tmp90, __value
	mov	rsi, rcx	#, _1
	mov	rdi, rax	#, __first.29_2
...
.LFB11588:
	...
	mov	rbp, rsp	#,
	.cfi_def_cfa_register 6
# Segment_Tree_Range_Sum.cpp:5: vector<long long> tree;
