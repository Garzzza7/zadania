...
long long recursive_bin_search(const long long f, const long long e, const long long target,
...
int main(void) {
    ...
    std::cout << "Recursive:\n "
              ...
              << vec[recursive_bin_search((long long) 0, (long long) (n - 1), (long long) 6, vec)]
              << "\n";
