...
#include <immintrin.h>
// types
using aligned_256f = __m256;
using aligned_256i = __m256i;
using aligned_256d = __m256d;
using unaligned_256f = __m256_u;
using unaligned_256i = __m256i_u;
using unaligned_256d = __m256d_u;

using aligned_512f = __m512;
using aligned_512i = __m512i;
using aligned_512d = __m512d;
using unaligned_512f = __m512_u;
using unaligned_512i = __m512i_u;
using unaligned_512d = __m512d_u;
// functions
...
// addsub functions
#define addsub_256d_aligned _mm256_addsub_pd
#define addsub_256f_aligned _mm256_addsub_ps
// add functions
#define and_256d_aligned _mm256_and_pd;
#endif // SIMD
